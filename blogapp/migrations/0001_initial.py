# Generated by Django 2.0 on 2017-12-12 11:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(blank=True, max_length=65, null=True, unique=True)),
                ('lvl', models.IntegerField()),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blogapp.Menu')),
            ],
        ),
        migrations.CreateModel(
            name='Page',
            fields=[
                ...
                ('slug', models.SlugField(max_length=65, unique=True)),
                ('photos', models.ManyToManyField(blank=True, to='blogapp.Gal_Image')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(blank=True, to='blogapp.Tags'),
        ),
    ]
